...
import { prisma } from '../prisma/prisma'; // Asegúrate de importar prisma desde el archivo correcto
...
app.get('/pronosticos', async (req: Request, res: Response) => {
    try {
...
app.get('/pronosticos/:id', async (req: Request, res: Response) => {
    const { id } = req.params;
    try {
...
app.post('/pronosticos', async (req: Request, res: Response) => {
...
app.delete('/pronosticos/:id', async (req: Request, res: Response) => {
    const { id } = req.params;
    try {
